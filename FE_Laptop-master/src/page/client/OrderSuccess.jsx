        ...
        subTitle={
          hasVnpayParams ? (
            <div style={{ textAlign: "left", maxWidth: "500px", margin: "0 auto" }}>
              <p>
                Đơn hàng <Text strong>#{paymentDetails?.orderId}</Text> đã được thanh toán thành công.
              </p>
              <p>
                Số tiền: <Text strong>{paymentDetails?.amount}</Text>
              </p>
              <p>
                Mã giao dịch: <Text strong>{paymentDetails?.transactionNo}</Text>
              </p>
              <p>
                Ngân hàng: <Text strong>{paymentDetails?.bank}</Text>
              </p>
              <p>
                Thời gian: <Text strong>{paymentDetails?.paymentTime}</Text>
              </p>
            </div>
          ) : (
